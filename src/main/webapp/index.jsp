...
<!--//fonts-->
<script type="text/javascript" src="${ctx }/static/js/move-top.js"></script>
<script type="text/javascript" src="${ctx }/static/js/easing.js"></script>
...
<body>
	...
	<div class="banner">
		...
		<!---->
		  <script src="${ctx }/static/js/jquery.wmuSlider.js"></script> 
			  <script>
       			$('.example1').wmuSlider({
					 pagination : false,
				});         
...
uspendisse venenatis dolor et nunc iaculis ege</p>
		<p class="footer-grid">Copyright &copy; 2015.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
