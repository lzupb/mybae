package sample.javafx.mediaplay;
...
//  private static final String MEDIA_URL = "file://D:/tools/eclipse/workspace/mytest/src/javafx/camera_out_high.mp4";
//	private static final String MEDIA_URL = "http://download.oracle.com/otndocs/products/javafx/JavaRap/prog_index.m3u8";
//	private static final String MEDIA_URL = "http://bcscdn.baidu.com/kanbaidu%2Fv%2F83711d82-9389-4e63-aa49-97dbe65653ef%2F68840601-0beb-47b9-89df-7aea4b4e1dfc%2Fts%2Fcamera_out_high-0.ts?sign=MBO%3ADdAwfjdWB9URJw1OTx8Y6Feu%3AXBNI%2FQc8n7VLafD9yP20p2eAnqY%3D";
	private MediaPlayer mediaPlayer;

    private void init(Stage primaryStage) throws IOException {
        Group root = new Group();
        primaryStage.setScene(new Scene(root));
		Resource resource = new ClassPathResource("/sample/camera_out_high.mp4");
		String mediasource = resource.getURI().toString();
